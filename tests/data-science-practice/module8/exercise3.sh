...
# Usage: ./exercise3.sh <username> <current_utc_time> <aws-access-key-id> <aws-secret-access-key> <aws-region>
...
RESULT_FILE="${RESULTS_DIR}/module${MODULE_NUMBER}_exercise3.json"  # File to store this exercise's results
IS_LOWER=false
...
# Using accuracy metric with 2 decimal precision tolerance
set +e
